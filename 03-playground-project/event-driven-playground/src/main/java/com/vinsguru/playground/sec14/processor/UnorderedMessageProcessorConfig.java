package com.vinsguru.playground.sec14.processor;

import com.vinsguru.playground.sec14.dto.DigitalDelivery;
...
public class UnorderedMessageProcessorConfig {
    ...
    private static final Logger log = LoggerFactory.getLogger(UnorderedMessageProcessorConfig.class);
